# -*- coding: utf-8 -*-
"""
Precio de opción americana con diferencias finitas usando QuantLib.
Misma firma que opcion_americana_fd.
"""
...
def opcion_americana_fd_ql(tipo, S, K, T, r, sigma, div, M=150):
    """
    Calcula el precio de una opción americana con diferencias finitas (QuantLib).
